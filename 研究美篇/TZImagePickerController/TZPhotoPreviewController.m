...
- (void)configCustomNaviBar {
    ...
    _titleLab.text = [NSString stringWithFormat:@"%zd/%ld",self.currentIndex +1,self.photoArr.count];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    _titleLab.text = [NSString stringWithFormat:@"%zd/%ld",self.currentIndex +1,(unsigned long)self.photoArr.count];
}
